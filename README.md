...
| [`nature-exam-thumbnail`](skills/nature-exam-thumbnail/README.md) | Beta | 批量生成学习平台考试缩略图：读库取缺图记录、拉取不重复图源、渲染统一风格 WebP、上传 R2/S3 并回写数据库 | “exam thumbnails”, “generate thumbnails”, “考试缩略图”, “试卷封面图”, “批量缩略图” | [详情](skills/nature-exam-thumbnail/README.md) |
