...
description: >-
  This skill should be used when the user asks to "polish my manuscript", "polish the
  abstract", "improve academic English", "Nature-style writing", "polish
  introduction/discussion/conclusion", "润色", "学术英语润色", or wants to refine academic prose into
  publication-quality, Nature-leaning English using curated writing patterns and Academic
  Phrasebank support.
version: 6.1.0
