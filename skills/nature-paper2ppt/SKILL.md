...
description: >-
  This skill should be used when the user asks to "make a PPT", "create slides", "做PPT",
  "做slides", "journal club presentation", "组会PPT", "论文分享PPT", "seminar slides", "presentation
  from paper", or wants to build a Nature-style Chinese PPTX presentation from a research paper
  with figures and speaker notes.
version: 2.0.0
